class Sui < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/MystenLabs/sui/releases/sui-mainnet-v1.15.1-macos-arm64.tgz"
    ...
    if Hardware::CPU.intel?
      url "https://github.com/MystenLabs/sui/releases/sui-mainnet-v1.15.1-macos-x86_64.tgz"
  ...
  on_linux do
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://github.com/MystenLabs/sui/releases/sui-mainnet-v1.15.1-ubuntu-x86_64.tgz"
